$(function(){
  var Bienes = {
    ...
    Init: function(){
      ...
      self.cargarSelect() 
      self.cargarTodos()
      self.formulario.submit(function(e){ //lo que debe hacer cuando se toca submit
        e.preventDefault()
        self.searchBienes()
      })
    },
    ...
    cargarTodos: function(){
      ...
      self.$btnTodos.on('click', (e)=>{
        var datos = {todos: ""} //a buscador.php como dato se le envia el parametro todos, ya que en el servidor se pregunta si existe POST['todos']
        self.ajaxData(datos)
      })
    },
